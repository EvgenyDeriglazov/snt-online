    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('s', models.PositiveIntegerField(blank=True, help_text='Показания э/счетчика (один тариф) на момент установки/приемки к учету в веб приложении', null=True, verbose_name='Один тариф')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(help_text='Текущая дата будет использована автоматически для нового тарифа за электроэнергию', verbose_name='Дата')),
        ...
        migrations.AddConstraint(
            model_name='erate',
            constraint=models.UniqueConstraint(fields=('date',), name='electricity_erate_date_unique_constraint'),
        ),
        migrations.AddConstraint(
            model_name='erate',
            constraint=models.CheckConstraint(check=models.Q(date__gte=datetime.date(2020, 6, 2)), name='electricity_erate_date_greater_or_equal_today_constraint'),
        ),
        migrations.AddConstraint(
            model_name='ecounter',
            constraint=models.UniqueConstraint(fields=('model_name', 'sn'), name='electricity_ecounter_model_name_sn_unique_constraint'),
        ),
    ]
